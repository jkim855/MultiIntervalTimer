...
class Start(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/1LapStartShort.mp3")
        ...
        if sim[0] == 0:
            ...
            global reroll
            reroll = ImageTk.PhotoImage(file="C:/Users/Jake/Desktop/TimerV2/reroll.png")
    ...
    def restart(self, button):
        ...
        pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/SymbolRestart.mp3")
        pygame.mixer.music.play(loops=0)
        """
    ...
    def update(self):
        ...
        if self.seconds_left2 == 3:
            pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/Symbol.mp3")
            pygame.mixer.music.play(loops=0)
        if self.seconds_left2 == 0:
            self.seconds_left2 = sim[0] #change to sim[0]
        if self.seconds_left == 3:
            pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/1LapStart.mp3")
            pygame.mixer.music.play(loops=0)
        if self.seconds_left == 0:
            if self.set_count == 4:
                self.set_count = 0
                pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/4Laps.mp3")
                pygame.mixer.music.play(loops=0)
    ...
    def update3(self):
        ...
        if self.seconds_left == data["time"]+3:
            pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/1LapBreak.mp3")
            pygame.mixer.music.play(loops=0)
        if self.seconds_left == 3:
            pygame.mixer.music.load("C:/Users/Jake/Desktop/TimerV2/1LapStart.mp3")
            pygame.mixer.music.play(loops=0)
