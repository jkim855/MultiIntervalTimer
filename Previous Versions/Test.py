...
class TimerApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #container.overridedirect(1)
        #container.wm_attributes("-transparentcolor", 'grey')
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        bg = ImageTk.PhotoImage(file="arcana.png")
        """
        c = tk.Canvas(self, width=300, height=465)
        ...
        label = tk.Label(self, bg = "grey", text="재획 타이머", font=LARGE_FONT
                         )
...
class Start(tk.Frame):
    def __init__(self, parent, controller):
        ...
        if data["late"] == True:
            self.seconds_left = 30*60-now.minute%30*60-now.second
